RSpec.describe Veeqo::Request do
  before do
    ...
    @klass = Veeqo::DummyClass
  end

  describe '.path' do
    it 'should have a path method to expose the path_builder' do
      expect(@klass.path).to be_kind_of Veeqo::PathBuilder
    end
  end
  ...
  describe 'ClassMethods' do
    ...
    describe '.raw_request' do
      ...
      it 'send its method to Veeqo.api' do
        response = double
    ...
    describe 'private methods' do
      describe '.build_response_object' do
        before do
          ...
          @klass_with_init = Veeqo::DummyClass
        end
        ...
        describe 'json array' do
          ...
          it 'should build an array of objects' do
            ...
            objs.each do |obj|
              expect(obj).to be_kind_of Veeqo::DummyClass
            end
          end
        end
        describe 'json object' do
          ...
          it 'should build an object' do
            ...
            allow(response).to receive(:body) { json }
            objs = @klass_with_init.send(:build_response_object, response)
            expect(objs).to be_kind_of Veeqo::DummyClass
          end
        end
      end
...
describe Veeqo::PathBuilder do
  let(:uri) { 'bar/%d' }
  before do
    @path_builder = Veeqo::PathBuilder.new uri
  end
